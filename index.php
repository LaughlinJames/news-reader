...
<?php
  ...
  $articleArray = Article::loadFiveNewest();
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="jumbotron">
        <h1>All the news from this year.</h1>
        <p class="lead">Welcome to the site. Please feel free to browse the articles.</p>
      </div>
      ...
      <div class="row-fluid marketing">
        <div class="span12">
          ...
          <p>
          	<a class="btn btn-block btn-primary" href="archive.php">More in the archive!</a>
          </p>
        </div>
      </div>
